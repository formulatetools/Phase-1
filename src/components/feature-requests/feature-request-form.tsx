...
export function FeatureRequestForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-2xl border border-primary-100 bg-surface p-6 shadow-sm">
      ...
      {success && (
        <div className="mb-4 rounded-xl border border-green-200 bg-green-50 p-3 text-sm text-green-700 dark:border-green-800 dark:bg-green-900/20 dark:text-green-300 flex items-center gap-2">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-primary-800 px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-primary-900 dark:bg-primary-800 dark:text-primary-50 dark:hover:bg-primary-900 disabled:opacity-50"
        >
          {loading ? (
            'Submitting...'
          ) : (
