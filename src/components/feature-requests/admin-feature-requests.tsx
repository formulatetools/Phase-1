        ...
        <div className="rounded-2xl border border-primary-100 bg-surface p-6 shadow-sm space-y-5">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={handleSave}
              disabled={saving}
              className="rounded-lg bg-primary-800 px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-primary-900 dark:bg-primary-800 dark:text-primary-50 dark:hover:bg-primary-900 disabled:opacity-50"
            >
