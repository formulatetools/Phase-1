...
export function WorksheetEditorForm({
  ...
  return (
    <form action={handleSubmit} className="space-y-6">
      ...
      <button
        type="submit"
        className="rounded-lg bg-primary-800 px-6 py-2.5 text-sm font-medium text-white transition-colors hover:bg-primary-900 dark:bg-primary-800 dark:text-primary-50 dark:hover:bg-primary-900"
      >
