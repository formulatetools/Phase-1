...
const COMMANDS: CommandItem[] = [
  ...
  { id: 'nav-library', label: 'Library', href: '/worksheets', icon: icons.resources, category: 'navigation', keywords: ['resources', 'worksheets', 'browse', 'search', 'library'] },
  ...
  { id: 'act-browse', label: 'Browse library', description: 'Search the worksheet library', href: '/worksheets', icon: icons.resources, category: 'action', keywords: ['search', 'find', 'resources', 'browse', 'library'] },
]
