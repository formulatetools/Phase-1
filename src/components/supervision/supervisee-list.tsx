  ...
  if (tierBlocked) {
    return (
      <div className="rounded-2xl border border-dashed border-primary-200 p-8 text-center">
        ...
        <Link
          href="/pricing"
          className="mt-4 inline-block rounded-lg bg-primary-800 px-4 py-2 text-sm font-medium text-white hover:bg-primary-900 dark:bg-primary-800 dark:text-primary-50 dark:hover:bg-primary-900"
        >
          Upgrade to access
        </Link>
      </div>
        ...
        <div className="rounded-2xl border border-brand/20 bg-brand-light p-4">
          <div className="flex items-center justify-between">
            ...
            {atLimit && (
              <Link
                href="/pricing"
                className="rounded-lg bg-primary-800 px-3 py-1.5 text-xs font-medium text-white hover:bg-primary-900 dark:bg-primary-800 dark:text-primary-50 dark:hover:bg-primary-900"
              >
                Upgrade
              </Link>
            )}
      ...
      <div className="flex items-center justify-between">
        ...
        {!showAdd && (
          <button
            ...
            className="rounded-lg bg-primary-800 px-4 py-2 text-sm font-medium text-white hover:bg-primary-900 dark:bg-primary-800 dark:text-primary-50 dark:hover:bg-primary-900 transition-colors"
          >
            + Add supervisee
          </button>
        )}
        ...
        <div className="rounded-2xl border border-primary-200 bg-surface p-4 shadow-sm">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="rounded-lg bg-primary-800 px-4 py-2 text-sm font-medium text-white hover:bg-primary-900 dark:bg-primary-800 dark:text-primary-50 dark:hover:bg-primary-900 disabled:opacity-50 transition-colors"
            >
              {loading ? 'Adding…' : 'Add'}
            </button>
            <button
      ...
      {activeSupervisees.length === 0 && !showAdd ? (
        <div className="rounded-2xl border border-dashed border-primary-200 p-8 text-center">
          ...
          <button
            ...
            className="mt-4 rounded-lg bg-primary-800 px-4 py-2 text-sm font-medium text-white hover:bg-primary-900 dark:bg-primary-800 dark:text-primary-50 dark:hover:bg-primary-900"
          >
