  ...
  return (
    <div className="space-y-3">
      ...
      >
        ...
        {activeTag && <span className="rounded-full bg-primary-800 px-1.5 py-0.5 text-[10px] text-white dark:bg-primary-200 dark:text-primary-900">1</span>}
      </button>
        ...
        {displayTags.map((tag) => (
          <button
            ...
            className={`rounded-full px-2.5 py-1 text-xs font-medium transition-all ${
              activeTag === tag
                ? 'bg-primary-800 text-white dark:bg-primary-200 dark:text-primary-900 shadow-sm'
