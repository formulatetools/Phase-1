...
interface WorksheetExportProps {
  ...
  onExport?: () => void
  /** Resolved branding options for PDF. If undefined, falls back to showBranding: true. */
  branding?: PdfBrandingOptions
  /** Worksheet schema — required for PDF and interactive HTML export. */
...
export function WorksheetExport({
  ...
  const handlePdfExport = useCallback(async () => {
    ...
    try {
      ...
      await downloadFillablePdf({
        ...
        description: worksheetDescription || undefined,
        instructions: worksheetInstructions || undefined,
  ...
  }, [worksheetTitle, onExport, branding, schema, worksheetDescription, worksheetInstructions])
