...
export function BookmarkBanner() {
  ...
  return (
    <div className="rounded-xl border border-brand/20 bg-brand-light p-3 flex items-center justify-between gap-3">
      ...
      <button
        onClick={dismiss}
        className="shrink-0 rounded-lg px-3 py-2 text-xs text-primary-500 dark:text-primary-600 hover:bg-brand/10 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40 min-h-[44px]"
