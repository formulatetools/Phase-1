...
export default async function AdminUsersPage() {
  ...
  return (
    <div className="px-4 py-8 sm:px-8 lg:px-12">
      ...
      {/* ── Stat cards ──────────────────────────────────────────────── */}
      <div className="mb-8 grid gap-4 grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
      ...
      {/* ── Retention Cohorts ────────────────────────────────────────── */}
      <div className="mb-8 rounded-2xl border border-primary-100 bg-white shadow-sm">
          ...
          <table className="w-full text-left text-sm">
            <thead className="border-b border-primary-50 bg-primary-50/50">
              <tr>
                ...
                <th className="px-6 py-3 font-medium text-primary-500">Last Active</th>
