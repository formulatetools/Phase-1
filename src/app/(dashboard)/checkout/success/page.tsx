      ...
      <div className="w-full max-w-lg text-center">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-3">
          {nextSteps.map((step) => (
            ...
            >
              <div className={`mx-auto flex h-10 w-10 items-center justify-center rounded-xl ${step.color} transition-colors group-hover:bg-primary-800 group-hover:text-white dark:group-hover:bg-primary-200 dark:group-hover:text-primary-900`}>
                {step.icon}
              </div>
